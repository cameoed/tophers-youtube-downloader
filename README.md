...
On Mac, open the app or install helper by Control-clicking it, choosing Open, then choosing Open again if macOS asks. If it is still blocked, use System Settings > Privacy & Security > Open Anyway.
